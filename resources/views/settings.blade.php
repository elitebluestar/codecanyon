									...
									<form method="post" action="{{action('SomeController@updatewebinfo')}}" enctype="multipart/form-data">
										...
										<div class="sign-u">
                                            ...
                                            <div class="custom-file mb-3">
												<input style="padding-bottom:39px;" name="logo" class="form-control custom-file-input" type="file"><br>
							...
							<div class="tab-pane" id="6">
								<div class="sign-up-row widget-shadow">
									<form method="post" action="{{action('SomeController@updatesubfee')}}">
										...
										<div class="sub_home">
											<input type="submit" class="btn btn-primary" value="Save">											<div class="clearfix"> </div>
										</div>
										<input type="hidden" name="id" value="1">
										<input type="hidden" name="_token" value="{{ csrf_token() }}"><br/>
									</form>
