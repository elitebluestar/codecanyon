                ...
                <div class="containter">
                		...
                		<div class="col-lg-4">
							<div class="sign-up-row widget-shadow" style="width:100%; padding:0px;">
								...
								{{$plan->name}}
								@if(Auth::user()->type=="1")
								<a href="#" data-toggle="modal" data-target="#editplansModal{{$plan->id}}" class="btn btn-success"><i class="fa fa-pencil"></i></a>&nbsp; &nbsp;
								<a href="{{ url('dashboard/trashplan') }}/{{$plan->id}}" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
								@endif
								</h3>
