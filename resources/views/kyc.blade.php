						...
						<tbody> 
							...
							<tr> 
								<th scope="row">{{$list->id}}</th>
								 ...
								 <td>
								<a href="#"  data-toggle="modal" data-target="#viewkycIModal{{$list->id}}" class="btn btn-info"><i class="fa fa-eye"></i> ID</a>
								<a href="#" data-toggle="modal" data-target="#viewkycPModal{{$list->id}}" class="btn btn-info"><i class="fa fa-eye"></i> Passport</a>
								
								<a href="{{ url('dashboard/acceptkyc') }}/{{$list->id}}" class="btn btn-success">Accept</a>
								 <a href="{{ url('dashboard/rejectkyc') }}/{{$list->id}}" class="btn btn-danger">Reject</a>
								 </td> 
							</tr> 
