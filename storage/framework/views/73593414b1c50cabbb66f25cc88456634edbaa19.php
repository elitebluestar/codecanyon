						...
						<tbody> 
							...
							<tr> 
								<th scope="row"><?php echo e($list->id); ?></th>
								 ...
								 <td>
								<a href="#"  data-toggle="modal" data-target="#viewkycIModal<?php echo e($list->id); ?>" class="btn btn-info"><i class="fa fa-eye"></i> ID</a>
								<a href="#" data-toggle="modal" data-target="#viewkycPModal<?php echo e($list->id); ?>" class="btn btn-info"><i class="fa fa-eye"></i> Passport</a>
								
								<a href="<?php echo e(url('dashboard/acceptkyc')); ?>/<?php echo e($list->id); ?>" class="btn btn-success">Accept</a>
								 <a href="<?php echo e(url('dashboard/rejectkyc')); ?>/<?php echo e($list->id); ?>" class="btn btn-danger">Reject</a>
								 </td> 
							</tr> 
