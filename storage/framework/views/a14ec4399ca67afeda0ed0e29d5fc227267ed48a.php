			...
			<div class="main-page signup-page">
				...
				<span style="margin:3px;">
				    ...
				    <form style="padding:3px; float:right;" role="form" method="post" action="<?php echo e(action('Controller@search')); ?>">
				            <a class="btn btn-primary" href="<?php echo e(url('dashboard/manageusers')); ?>">Show all</a>
					   		<input style="padding:5px; margin-top:15px;" placeholder="Search user" type="text" name="searchItem" required>
					   		<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
					   		<input type="hidden" name="type" value="subscription">
					   		<input type="submit" style="margin-top:-5px;" class="btn btn-success" value="Go">
					  </form>
				...
				<a href="<?php echo e(url('dashboard/kyc')); ?>" class="btn btn-success btn-lg">KYC</a>
				<?php endif; ?>
