<?php echo $__env->make('header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				...
				<a class="btn btn-primary" href="#" data-toggle="modal" data-target="#plansModal"><i class="fa fa-plus"></i> New plan</a>
                ...
                <div class="containter">
                		...
                		<div class="col-lg-4">
							<div class="sign-up-row widget-shadow" style="width:100%; padding:0px;">
								...
								<a href="#" data-toggle="modal" data-target="#editplansModal<?php echo e($plan->id); ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>&nbsp; &nbsp;
								<a href="<?php echo e(url('dashboard/trashplan')); ?>/<?php echo e($plan->id); ?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
								<?php endif; ?>
								</h3>
								...
								<h4><strong><?php echo e($settings->currency); ?><?php echo e($plan->price); ?>+</strong><br><br><small> <b>Min. Possible deposit:</b>  <?php echo e($settings->currency); ?><?php echo e($plan->min_price); ?> <br><b>Max. Possible deposit:</b> <?php echo e($settings->currency); ?><?php echo e($plan->max_price); ?></small></h4>
									...
									<form style="padding:3px;" role="form" method="post" action="<?php echo e(action('Controller@joinplan')); ?>">
                                       ...
                                       <hr>
            					   		...
            					   		<input type="submit" class="btn btn-primary" value="Join plan">
            					   </form>
								</div>
							</div>
						</div>
